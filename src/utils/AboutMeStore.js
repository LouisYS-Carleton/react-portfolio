const AboutMeStore = [
  {
    ...
    topic:
      "Goal-oriented & high-energy professional with customer service & hospitality experience. Adaptable & dedicated, with a strong desire to learn & grow. Ability to work under pressure, and a fast learner with excellent communication skills. ",
    continueTopic:
      "Having spent multiple years as a chef in various fast-paced environments, I realized that my creative nature is highly beneficial when applied to a professional industry. Combining this realization with my love for technology I began a university level bootcamp in Web Development to pave my path to a future that I can be proud of.",
    skillsTitle: "Technical skills:",
    skills:
      "React.js, Javascript, HTML, CSS, MongoDB, mySQL, Heroku, Bootstrap, Bulma",
  },
  // {
  //   image: "./Assets/Cydcor-why-door-to-door-sales-scaled.jpeg",
  //   alt: "Door to door",
